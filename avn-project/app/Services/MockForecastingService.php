...
class MockForecastingService
{
    public function generate72HourForecast(TelemetryNode $node)
    {
        ...
        for ($i = 1; $i <= 72; $i++) {
            ...
            // Using explicit string formatting for date objects because Forecast::insert()
            // bypasses standard Eloquent casting and serialization. Manually including
            // created_at and updated_at timestamps is required for bulk inserts.
            $forecasts[] = [
