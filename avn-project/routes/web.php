...
Route::get('/nodes/{id}', function($id) {
    ...
    return view('node_details', [
        'node' => $node,
        // Optimization: Use indexed 'recorded_at' column instead of default unindexed 'created_at'
...
Route::get('/alerts', function() {
    // Optimization: Use indexed 'triggered_at' column instead of default unindexed 'created_at'
