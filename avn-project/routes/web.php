...
Route::get('/nodes/{id}', function($id) {
    ...
    return view('node_details', [
        'node' => $node,
        // Explicitly order by recorded_at to hit recorded_at column index instead of created_at
...
Route::get('/alerts', function() {
    // Explicitly order by triggered_at to hit triggered_at column index instead of created_at
